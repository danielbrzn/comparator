	...
	return new Promise(
		function(resolve, reject) {
			...
			request({
				...
				$ = cheerio.load(body);
				console.log(body);
				console.log($('a.a-link-normal.s-access-detail-page.s-color-twister-title-link.a-text-normal').first().attr('href'));
				var prodLink = $('a.a-link-normal.s-access-detail-page.s-color-twister-title-link.a-text-normal').first().attr('href');
